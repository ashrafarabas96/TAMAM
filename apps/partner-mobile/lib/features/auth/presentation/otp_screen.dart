...
import 'package:tamam_partner/features/auth/presentation/auth_controller.dart';
import 'package:tamam_partner/features/auth/presentation/widgets/auth_scaffold.dart';
import 'package:tamam_partner/features/auth/presentation/widgets/otp_input.dart';
...
/// redirect sends the partner to the wizard, the review screen or home.
...
class _OtpScreenState extends ConsumerState<OtpScreen> {
  ...
  Future<void> _verify(String code) async {
    ...
    final bool ok = await ref.read(authControllerProvider.notifier).verify(code);
