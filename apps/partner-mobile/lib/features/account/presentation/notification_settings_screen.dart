                ...
                child: Column(
                  children: <Widget>[
                    SwitchListTile.adaptive(
                      ...
                      value: prefs.push,
                      onChanged: (bool value) => unawaited(controller.save(prefs.copyWith(push: value))),
                    ),
                    SwitchListTile.adaptive(
                    ...
                    SwitchListTile.adaptive(
                      ...
                      value: prefs.email,
                      onChanged: (bool value) => unawaited(controller.save(prefs.copyWith(email: value))),
                    ),
                    SwitchListTile.adaptive(
                      title: Text(l10n.preferencesMarketing),
                      subtitle: Text(l10n.preferencesMarketingHint),
                      value: prefs.marketing,
                      onChanged: (bool value) => unawaited(controller.save(prefs.copyWith(marketing: value))),
                    ),
                  ],
                ),
              ),
