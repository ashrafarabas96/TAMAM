        ...
        items={[
          {
            ...
            content: <CategoriesPanel onEdit={setEditing} onCreate={() => setCreating(true)} />,
          },
          {
            value: 'vehicle-types',
            label: t('services.vehicleTypes'),
            content: <VehicleTypesPanel />,
          },
          {
            value: 'package-categories',
            label: t('services.packageCategories'),
            content: <PackageCategoriesPanel />,
          },
        ]}
      />
      <CategoryDialog
