...
export const notificationsApi = {
  ...
  upsertTemplate: (input: UpsertNotificationTemplateInput) =>
    api.put<NotificationTemplateRow>('/admin/notification-templates', input),
  broadcast: (input: BroadcastNotificationInput) =>
    api.post<{ queued?: number; ok?: boolean }>('/admin/notifications/broadcast', input),
};
