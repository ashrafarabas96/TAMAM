...
export class AuthController {
  ...
  requestOtp(
    @ZodBody(requestOtpSchema) input: RequestOtpInput,
  ...
  verifyOtp(
    @ZodBody(verifyOtpSchema) input: VerifyOtpInput,
    @ClientIp() ip: string | null,
  ...
  adminLogin(
    @ZodBody(adminLoginSchema) input: AdminLoginInput,
    @ClientIp() ip: string | null,
    @UserAgent() ua: string | null,
  ) {
  ...
  async changePassword(
    ...
    @ZodBody(adminChangePasswordSchema) input: AdminChangePasswordInput,
    @ClientIp() ip: string | null,
  ) {
