...
describe('scoreCandidates', () => {
  it('prefers the closer partner when everything else is equal', () => {
    const r = scoreCandidates(
      [
        { partnerId: 'far', distanceMeters: 4000, etaSeconds: 600, ...base },
        { partnerId: 'near', distanceMeters: 500, etaSeconds: 90, ...base },
      ],
      w,
      5000,
    );
  ...
  it('rating alone cannot beat a much closer partner (spec §20)', () => {
    const r = scoreCandidates(
      [
        ...
        { partnerId: 'near', distanceMeters: 400, etaSeconds: 80, ...base, rating: 4.2 },
      ],
      w,
      5000,
    );
  ...
  it('penalises high cancellation and penalty points', () => {
    const r = scoreCandidates(
      [
        ...
        { partnerId: 'steady', distanceMeters: 1000, etaSeconds: 200, ...base },
      ],
      w,
      5000,
    );
