...
export const jobInclude = {
  ...
  vehicle: {
    select: {
      ...
      color: true,
      plate: true,
      vehicleType: { select: { nameAr: true, nameEn: true } },
    },
  },
  zone: {
    select: { id: true, code: true, currency: true, timezone: true, nameAr: true, nameEn: true },
  },
  customer: {
