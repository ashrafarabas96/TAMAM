...
export class JobsController {
  ...
  create(
    ...
    @ZodBody(createJobSchema) input: CreateJobInput,
  ...
  list(
    @CurrentUser() user: RequestUser,
    @ZodQuery(listSchema) filter: JobListFilterInput & PageRequestInput,
  ) {
  ...
  cancel(
    ...
    @ZodBody(cancelJobSchema) input: CancelJobInput,
  ...
  share(
    @CurrentUser() user: RequestUser,
    @Param('id', UuidPipe) id: string,
    @ZodBody(shareTripSchema) input: { expiresInMinutes: number },
  ) {
  ...
  sos(
    @CurrentUser() user: RequestUser,
    @Param('id', UuidPipe) id: string,
    @ZodBody(sosSchema) input: { location: { lat: number; lng: number }; note?: string },
  ) {
  ...
  enRoute(
    ...
    @Param('id', UuidPipe) id: string,
    @ZodBody(simpleTransitionSchema) i: SimpleTransitionInput,
    @RequestId() rid: string,
  ) {
    return this.lifecycle.enRoute(id, u, i, rid);
  }
  ...
  arrive(
    @CurrentUser() u: RequestUser,
    @Param('id', UuidPipe) id: string,
    @ZodBody(arriveJobSchema) i: ArriveJobInput,
    @RequestId() rid: string,
  ) {
    return this.lifecycle.arrive(id, u, i, rid);
  }
  ...
  start(
    @CurrentUser() u: RequestUser,
    @Param('id', UuidPipe) id: string,
    @ZodBody(startJobSchema) i: StartJobInput,
    @RequestId() rid: string,
  ) {
    return this.lifecycle.start(id, u, i, rid);
  }
  ...
  complete(
    @CurrentUser() u: RequestUser,
    @Param('id', UuidPipe) id: string,
    @ZodBody(completeJobSchema) i: CompleteJobInput,
    @RequestId() rid: string,
  ) {
    return this.lifecycle.complete(id, u, i, rid);
  }

  @Post('jobs/:id/work/start')
  @HttpCode(200)
  @RequireRole('PARTNER')
  startWork(
    @CurrentUser() u: RequestUser,
    ...
    return this.lifecycle.startWork(id, u, i, rid);
  }

  @Post('jobs/:id/work/waiting-for-parts')
  @HttpCode(200)
  @RequireRole('PARTNER')
  waitingForParts(
    @CurrentUser() u: RequestUser,
    ...
    return this.lifecycle.waitingForParts(id, u, i, rid);
  }

  @Post('jobs/:id/work/resume')
  @HttpCode(200)
  @RequireRole('PARTNER')
  resumeWork(
    @CurrentUser() u: RequestUser,
    ...
    return this.lifecycle.resumeWork(id, u, i, rid);
  }

  @Post('jobs/:id/work/complete')
  @HttpCode(200)
  @RequireRole('PARTNER')
  completeWork(
    @CurrentUser() u: RequestUser,
    ...
    return this.lifecycle.completeWork(id, u, i, rid);
  }
  ...
  adminList(
    @CurrentUser() u: RequestUser,
    @ZodQuery(listSchema) f: JobListFilterInput & PageRequestInput,
  ) {
    return this.jobs.listForUser(u, f);
  }

  @Get('admin/jobs/:id')
  @RequirePermission(Permission.JOBS_READ_ALL)
  adminGet(@CurrentUser() u: RequestUser, @Param('id', UuidPipe) id: string) {
    return this.jobs.getDto(id, u, true);
  }

  @Post('admin/jobs/:id/transition')
  @HttpCode(200)
  @RequirePermission(Permission.JOBS_CANCEL)
  @Audited({ action: 'job.admin_transition', entity: 'job', entityIdFrom: 'id', sensitive: true })
  adminTransition(
    @CurrentUser() u: RequestUser,
    @Param('id', UuidPipe) id: string,
    @ZodBody(adminTransitionSchema) i: AdminTransitionInput,
    @RequestId() rid: string,
  ) {
    return this.lifecycle.adminTransition(id, u, i.toStatus, i.reason, i.version, rid);
  }

  @Get('admin/sos')
  @RequirePermission(Permission.JOBS_READ_ALL)
  sosList() {
    return this.safety.listOpenSos();
  }

  @Post('admin/sos/:id/acknowledge')
  @HttpCode(200)
  @RequirePermission(Permission.JOBS_READ_ALL)
  async sosAck(@CurrentUser() u: RequestUser, @Param('id', UuidPipe) id: string) {
    await this.safety.acknowledgeSos(id, u);
    return { ok: true };
  }
  ...
  @HttpCode(200)
  @RequirePermission(Permission.JOBS_READ_ALL)
  async sosResolve(@CurrentUser() u: RequestUser, @Param('id', UuidPipe) id: string) {
    await this.safety.resolveSos(id, u);
    return { ok: true };
  }
}
