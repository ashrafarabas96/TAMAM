...
const SERVICE_TYPES: Array<{
...
}> = [
  {
    ...
    nameAr: 'رحلات',
    nameEn: 'Rides',
    descriptionAr: 'توصيل ركاب داخل المدينة وبينها',
    descriptionEn: 'Passenger rides inside and between cities',
    colorHex: '#5D3EBC',
    sortOrder: 1,
    isActive: true,
    featureFlagKey: null,
  ...
  {
    code: JobType.DELIVERY,
    nameAr: 'توصيل طرود',
    nameEn: 'Delivery',
    descriptionAr: 'إرسال واستلام الطرود بسرعة',
    descriptionEn: 'Send and receive parcels quickly',
    colorHex: '#FFD300',
    sortOrder: 2,
    isActive: true,
    featureFlagKey: null,
  ...
  {
    code: JobType.HOME_SERVICE,
    nameAr: 'خدمات منزلية',
    nameEn: 'Home services',
    descriptionAr: 'فنيون معتمدون لصيانة منزلك',
    descriptionEn: 'Vetted technicians for your home',
    colorHex: '#00A67E',
    sortOrder: 3,
    isActive: true,
    featureFlagKey: null,
  ...
  // Reserved verticals: the engine already understands them, the modules ship later (spec §2).
  {
    ...
    nameAr: 'مطاعم',
    nameEn: 'Food',
    descriptionAr: 'قريبًا',
    descriptionEn: 'Coming soon',
    colorHex: '#E4572E',
    sortOrder: 10,
    isActive: false,
    featureFlagKey: FEATURE_FLAGS.FOOD_MODULE,
  },
  {
    code: JobType.GROCERY,
    nameAr: 'بقالة',
    nameEn: 'Grocery',
    descriptionAr: 'قريبًا',
    descriptionEn: 'Coming soon',
    ...
    sortOrder: 11,
    isActive: false,
    featureFlagKey: FEATURE_FLAGS.GROCERY_MODULE,
  },
  {
    code: JobType.PHARMACY,
    nameAr: 'صيدلية',
    nameEn: 'Pharmacy',
    descriptionAr: 'قريبًا',
    descriptionEn: 'Coming soon',
    ...
    sortOrder: 12,
    isActive: false,
    featureFlagKey: FEATURE_FLAGS.PHARMACY_MODULE,
  },
  {
    code: JobType.SHOPPING,
    nameAr: 'تسوق',
    nameEn: 'Shopping',
    descriptionAr: 'قريبًا',
    descriptionEn: 'Coming soon',
    ...
    sortOrder: 13,
    isActive: false,
    featureFlagKey: FEATURE_FLAGS.MERCHANT_MODULE,
  },
  // No dedicated flag exists yet — an unknown key resolves to "disabled", which is the intent.
  {
    ...
    sortOrder: 14,
    isActive: false,
    featureFlagKey: 'moving_module',
  },
  {
    code: JobType.ROAD_ASSISTANCE,
    nameAr: 'مساعدة على الطريق',
    nameEn: 'Road assistance',
    descriptionAr: 'قريبًا',
    descriptionEn: 'Coming soon',
    colorHex: '#C0392B',
    sortOrder: 15,
    isActive: false,
    featureFlagKey: 'road_assistance_module',
  },
];
...
const VEHICLE_TYPES: Array<{
...
}> = [
  {
    ...
    nameAr: 'اقتصادي',
    nameEn: 'Economy',
    descriptionAr: 'سيارة عادية حتى 4 ركاب',
    descriptionEn: 'Standard car, up to 4 passengers',
    seats: 4,
  ...
  },
  {
    ...
    nameAr: 'عائلي',
    nameEn: 'Family',
    descriptionAr: 'سيارة واسعة حتى 6 ركاب',
    descriptionEn: 'Roomy vehicle, up to 6 passengers',
    seats: 6,
    cargoCapacityKg: null,
    allowedJobTypes: [JobType.RIDE],
    sortOrder: 2,
  },
  {
    ...
    nameAr: 'مميز',
    nameEn: 'Premium',
    descriptionAr: 'سيارة حديثة براحة أعلى',
    descriptionEn: 'Newer, more comfortable car',
    seats: 4,
    cargoCapacityKg: null,
    allowedJobTypes: [JobType.RIDE],
    sortOrder: 3,
  },
  {
    ...
    nameAr: 'دراجة نارية',
    nameEn: 'Motorbike',
    descriptionAr: 'أسرع خيار للطرود الصغيرة',
    descriptionEn: 'Fastest option for small parcels',
    seats: 1,
    cargoCapacityKg: 15,
    allowedJobTypes: [JobType.DELIVERY],
    sortOrder: 4,
  },
  {
    code: 'DELIVERY_CAR',
    nameAr: 'سيارة توصيل',
    nameEn: 'Delivery car',
    descriptionAr: 'للطرود الكبيرة والهشة',
    descriptionEn: 'For large or fragile parcels',
    seats: 2,
    cargoCapacityKg: 300,
    allowedJobTypes: [JobType.DELIVERY],
    sortOrder: 5,
...
/* ------------------------------------------------------------ package categories */
const PACKAGE_CATEGORIES: Array<{
  code: string;
  nameAr: string;
  nameEn: string;
  descriptionAr: string;
  ...
  {
    code: 'DOCUMENTS',
    nameAr: 'أوراق ومستندات',
    nameEn: 'Documents',
    descriptionAr: 'ظرف أو ملف خفيف',
    descriptionEn: 'Envelope or light folder',
    maxWeightKg: 2,
    isFragile: false,
    isProhibited: false,
    sortOrder: 1,
  ...
  },
  {
    ...
    nameAr: 'طرد صغير',
    nameEn: 'Small parcel',
    descriptionAr: 'حتى 5 كغم',
    descriptionEn: 'Up to 5 kg',
    maxWeightKg: 5,
    isFragile: false,
    isProhibited: false,
    sortOrder: 2,
  ...
  },
  {
    code: 'MEDIUM',
    nameAr: 'طرد متوسط',
    nameEn: 'Medium parcel',
    descriptionAr: 'حتى 15 كغم',
    descriptionEn: 'Up to 15 kg',
    maxWeightKg: 15,
    isFragile: false,
    isProhibited: false,
    sortOrder: 3,
  ...
  },
  {
    ...
    nameAr: 'طرد كبير',
    nameEn: 'Large parcel',
    descriptionAr: 'حتى 50 كغم — يحتاج سيارة توصيل',
    descriptionEn: 'Up to 50 kg — needs a delivery car',
    maxWeightKg: 50,
    isFragile: false,
    isProhibited: false,
    sortOrder: 4,
    vehicleCodes: ['DELIVERY_CAR'],
  },
  {
    code: 'FRAGILE',
    nameAr: 'قابل للكسر',
    nameEn: 'Fragile',
    descriptionAr: 'زجاج وأجهزة — يحتاج سيارة توصيل',
    descriptionEn: 'Glass and electronics — needs a delivery car',
    maxWeightKg: 25,
    isFragile: true,
    isProhibited: false,
    sortOrder: 5,
  ...
  },
  {
    code: 'PROHIBITED',
    nameAr: 'مواد ممنوعة',
    nameEn: 'Prohibited items',
    descriptionAr: 'أسلحة، مواد قابلة للاشتعال، مواد مخدرة — لا تُنقل',
    descriptionEn: 'Weapons, flammables, narcotics — never carried',
    maxWeightKg: null,
    isFragile: false,
    isProhibited: true,
    sortOrder: 99,
...
const CATEGORIES: CategorySeed[] = [
  {
    ...
    searchKeywords:
      'سباك سباكة تسريب ماء مجاري مغسلة بانيو سخان plumber plumbing leak drain sink water heater',
    ...
    subcategories: [
      ...
      },
      {
        ...
        nameAr: 'مغسلة',
        nameEn: 'Sink',
        searchKeywords: 'مغسلة حوض sink basin',
      ...
      },
      {
        ...
        nameAr: 'كرسي حمام',
        nameEn: 'Toilet',
        searchKeywords: 'كرسي حمام تواليت toilet',
        estimatedDurationMin: 60,
      },
      {
        slug: 'pipes',
        nameAr: 'مواسير',
        nameEn: 'Pipes',
        searchKeywords: 'مواسير أنابيب pipes piping',
      ...
      },
      {
        ...
        nameAr: 'سخان مياه',
        nameEn: 'Water heater',
        searchKeywords: 'سخان بويلر water heater boiler',
        estimatedDurationMin: 120,
      },
    ],
  },
  {
    ...
    searchKeywords:
      'كهربائي كهرباء تمديدات مقبس إنارة لوحة electrician electric socket lighting panel',
    pricingMethod: PricingMethod.INSPECTION_QUOTE,
    requiredPartnerRole: PartnerRoleType.TECHNICIAN,
    inspectionFeeMinor: INSPECTION_FEE,
    hourlyRateMinor: null,
    ...
    subcategories: [
      {
        slug: 'power-outage',
        nameAr: 'انقطاع كهرباء',
        nameEn: 'Power outage',
        searchKeywords: 'انقطاع كهرباء outage',
        estimatedDurationMin: 60,
      },
      {
        slug: 'socket',
        nameAr: 'مقبس كهرباء',
        nameEn: 'Socket',
        searchKeywords: 'مقبس بريزة socket outlet',
      ...
      },
      {
        ...
        nameAr: 'إنارة',
        nameEn: 'Lighting',
        searchKeywords: 'إنارة لمبة ثريا lighting lamp',
        estimatedDurationMin: 60,
      },
      {
        slug: 'panel',
        ...
        searchKeywords: 'لوحة طبلون panel breaker',
        estimatedDurationMin: 120,
      },
    ],
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        nameAr: 'شحن غاز',
        nameEn: 'Gas refill',
        searchKeywords: 'غاز فريون gas freon',
        estimatedDurationMin: 90,
      },
      {
        slug: 'repair',
        nameAr: 'إصلاح عطل',
        nameEn: 'Repair',
        searchKeywords: 'إصلاح عطل repair fix',
        estimatedDurationMin: 120,
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        searchKeywords: 'غسالة washing machine',
        estimatedDurationMin: 90,
      },
      {
        slug: 'fridge',
        nameAr: 'ثلاجة',
        nameEn: 'Refrigerator',
        searchKeywords: 'ثلاجة براد fridge',
        estimatedDurationMin: 90,
      },
      {
        slug: 'oven',
    ...
    subcategories: [
      {
        ...
        nameAr: 'فتح باب',
        nameEn: 'Door opening',
        searchKeywords: 'فتح باب open door',
        estimatedDurationMin: 45,
      },
      {
        slug: 'lock-change',
        nameAr: 'تغيير قفل',
        nameEn: 'Lock change',
        searchKeywords: 'تغيير قفل change lock',
        estimatedDurationMin: 60,
      },
    ],
  },
    ...
    subcategories: [
      {
        slug: 'window',
        nameAr: 'شباك ألمنيوم',
        nameEn: 'Aluminium window',
        searchKeywords: 'شباك window',
        estimatedDurationMin: 180,
      },
      {
        slug: 'mosquito-net',
        nameAr: 'شبك حماية',
        nameEn: 'Mosquito net',
        searchKeywords: 'شبك ناموسية net',
        estimatedDurationMin: 90,
      },
    ],
  },
  {
    ...
    searchKeywords:
      'صيانة أجهزة حاسوب لابتوب شاشة تلفزيون device maintenance computer laptop tv screen',
    pricingMethod: PricingMethod.INSPECTION_QUOTE,
    requiredPartnerRole: PartnerRoleType.TECHNICIAN,
    inspectionFeeMinor: INSPECTION_FEE,
    hourlyRateMinor: null,
    ...
    subcategories: [
      ...
      },
      {
        ...
        nameAr: 'تلفزيون',
        nameEn: 'Television',
        searchKeywords: 'تلفزيون شاشة tv',
        estimatedDurationMin: 120,
      },
    ],
  },
...
export async function seedCatalog(ctx: SeedContext): Promise<CatalogSeedResult> {
  ...
  for (const st of SERVICE_TYPES) {
    const row = await prisma.serviceType.upsert({
      ...
      update: {
        ...
        featureFlagKey: st.featureFlagKey,
      },
      create: {
        code: st.code,
        nameAr: st.nameAr,
  ...
  for (const vt of VEHICLE_TYPES) {
    const row = await prisma.vehicleType.upsert({
      ...
      update: {
        ...
        seats: vt.seats,
        cargoCapacityKg: vt.cargoCapacityKg,
        allowedJobTypes: vt.allowedJobTypes,
  ...
  for (const pc of PACKAGE_CATEGORIES) {
    const requiresVehicleTypeIds = pc.vehicleCodes
      .map((code) => vehicleTypeIds.get(code))
    ...
    const row = await prisma.packageCategory.upsert({
      ...
      update: {
        ...
        maxWeightKg: pc.maxWeightKg,
        requiresVehicleTypeIds,
        isFragile: pc.isFragile,
        isProhibited: pc.isProhibited,
        sortOrder: pc.sortOrder,
        isActive: !pc.isProhibited,
      },
      create: {
        code: pc.code,
        nameAr: pc.nameAr,
  ...
  for (const cat of CATEGORIES) {
    const workflowConfig =
      cat.pricingMethod === PricingMethod.INSPECTION_QUOTE ? WORKFLOW_QUOTE : WORKFLOW_DIRECT;
    const data = {
    ...
    for (const [index, sub] of cat.subcategories.entries()) {
      ...
      for (const option of sub.options ?? []) {
        ...
        const existing = await prisma.serviceOption.findFirst({
          where: { subcategoryId: subRow.id, nameEn: option.nameEn },
        });
        if (existing) {
