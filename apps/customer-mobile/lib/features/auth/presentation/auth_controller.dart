...
/// three methods; no networking or token handling lives in a widget.
class AuthController extends Notifier<AuthFlowState> {
  ...
  Future<bool> verify(String code, {String? referralCode}) async {
    final String? phone = state.phone;
    if (phone == null) return false;
  ...
  /// Resets the flow when the customer edits their phone number.
