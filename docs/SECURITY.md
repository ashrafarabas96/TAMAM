...
*An attacker brute-forces an OTP, reuses a refresh token, or keeps a session after a password reset.*
...
*A signed-in user guesses a job/payment/dispute id.*
...
*Someone edits a wallet balance, replays a capture, or unbalances the ledger.*
