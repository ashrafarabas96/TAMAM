...
if "%PROBLEM%"=="WSL_NO_VIRT" (
  ...
  call :say ""
  call :say "  1. Double-click FIX-WSL.bat, next to this file."
  call :say "     It asks Windows for permission, then does it for you."
  call :say "  2. RESTART the computer when it tells you to."
  call :say "  3. Open Docker Desktop and wait for 'Engine running'."
  call :say "  4. Double-click START-WINDOWS.bat"
  call :say ""
